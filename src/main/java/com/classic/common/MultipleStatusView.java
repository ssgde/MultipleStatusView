...
public class MultipleStatusView extends RelativeLayout {
    ...
    private final ArrayList<Integer> mOtherEmptyIds = new ArrayList<>();
    ...
    @Override protected void onDetachedFromWindow() {
        ...
        if(null!=mOtherEmptyIds){
            mOtherEmptyIds.clear();
        }
...
//           if(mOtherEmptyIds.contains(view.getId())){
...
//                view.setVisibility(View.GONE );
//            }else if(mOtherEmptyIds.contains(view.getId())){
